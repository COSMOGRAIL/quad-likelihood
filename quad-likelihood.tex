...
say C=A+B.\\ \com{mt}{mention noise, speak about random 
variables}\com{vb}{Not yet (that's question 2), let's start by assuming 
that my measurement is noiseless}
\\
...
% and $C_{model} = C_{obs}$,
I can build from my observations the two 
